...
import img1 from '../../assets/boxer/img1.png';
import img2 from '../../assets/boxer/img2.png';
import img3 from '../../assets/boxer/img3.png';
import img4 from '../../assets/boxer/img4.png';
import img5 from '../../assets/boxer/img5.png';
import img6 from '../../assets/boxer/img6.png';
import grooming1 from '../../assets/boxer/grooming1.png';
import paw from '../../assets/boxer/paw.png';
import brush from '../../assets/Categories/brush.png';
import shampoo from '../../assets/Categories/shampoo.png';
import training1 from '../../assets/boxer/training1.png';
import training2 from '../../assets/boxer/training2.png';
import training3 from '../../assets/boxer/training3.png';
import health from '../../assets/boxer/health.png';
...
import interactive from '../../assets/boxer/interactive.png';
import puzzle from '../../assets/Labrador/puzzle.png';
import chew from '../../assets/boxer/chew.png';
import ear from '../../assets/boxer/ear.png';
import dental from '../../assets/boxer/dental.png';


const BoxerPage = ({ onBackClick }) => {
  ...
  const faqData = [
  {
    question: 'Do Boxers shed a lot?',
    answer: 'Boxers have short, smooth coats that shed moderately. Regular brushing helps manage loose hair and keeps their coat shiny and healthy.'
  },
  {
    question: 'How much exercise do Boxers need?',
    answer: 'Boxers are energetic and athletic dogs that require plenty of exercise. Daily long walks, play sessions, and activities like running or agility training are ideal to keep them fit and happy.'
  },
  {
    question: 'Are Boxers good with other dogs?',
    answer: 'Boxers are generally friendly and playful with other dogs, especially when socialized from a young age. However, their high energy and enthusiasm can sometimes overwhelm more timid breeds.'
  },
  {
    question: 'Do Boxers bark a lot?',
    answer: 'Boxers are not excessive barkers, but they will bark to alert their family of strangers or unusual activities. Proper training can help manage unnecessary barking.'
  },
  {
    question: 'Is a Boxer a good guard dog?',
    answer: 'Yes, Boxers are known to be protective and alert. Their strong build, loyalty, and natural guarding instincts make them excellent watchdogs as well as loving family companions.'
  }
];
...
<nav className="sticky top-0 bg-white z-10 shadow-md">
    ...
    {[
      ...
      >
        ...
        <div ref={aboutRef}>
          ...
          <section className="mb-12 bg-gradient-to-r from-blue-200 to-blue-300 p-8 rounded-xl shadow-lg flex flex-col lg:flex-row items-center gap-8">
  {/* Text Section */}
  ...
  <div className="lg:w-1/2 flex justify-center">
    ...
    />
          ...
          <section className="mb-12 bg-orange-100 p-8 rounded-lg shadow-md flex flex-col md:flex-row gap-8 text-gray-800">
            <div className="md:w-1/2">
              <h3 className="text-2xl font-semibold mb-4 border-b border-gray-400 pb-2">Coat: Sleek and Short</h3>
              <p className="text-lg mb-2"><span className="font-semibold">Shedding:</span> Moderate</p>
              <p className="text-lg mb-2"><span className="font-semibold">Size:</span>Medium to Large</p>
            ...
            <div className="md:w-1/2">
              ...
              <div className="flex space-x-4 mb-4">
                <span className="bg-white text-black font-semibold px-4 py-1 rounded-full">White</span>
                <span className="bg-[#AF580F] text-black font-semibold px-4 py-1 rounded-full">Brindle</span>
                <span className="bg-[#E5AA70] text-black font-semibold px-4 py-1 rounded-full">Fawn</span>
                
              </div>
              <div className="mb-4">
  <div className="grid grid-cols-3 gap-4 text-lg mb-2">
    <span className="font-semibold">Weight:</span>
    <span>27-32 kgs <span className='font-bold'>(male)</span></span>
    <span>25-29 kgs <span className='font-bold'>(female)</span></span>
  </div>
  <div className="grid grid-cols-3 gap-4 text-lg">
    <span className="font-semibold">Height:</span>
    <span>57-63 cm <span className='font-bold'>(male)</span></span>
    <span>53-60 cm <span className='font-bold'>(female)</span></span>
  </div>
</div>
...
<section className="mb-12 bg-cyan-200 p-4 rounded-lg shadow-md flex flex-col lg:flex-row items-center gap-8">
  {/* Left Text */}
  <div className="lg:w-1/3 text-center lg:text-left">
    ...
    <p className="text-lg text-gray-700">
      Temperatures should be cool to moderate for Boxers
    </p>
  </div>
  ...
  <div className="lg:w-1/3 flex justify-center">
    <img
      ...
      className="w-48 sm:w-56 lg:w-54 object-cover"
    />
  </div>
...
<section className="mb-12 bg-gray-100 rounded-lg shadow-lg overflow-hidden">
  ...
  <div className="flex-1 text-left">
    ...
    <p className="text-gray-700 text-xl">
      Consider following tips when choosing food for your Boxer.
    </p>
  </div>
  ...
  <div className="flex-1 text-left">
    ...
    <p className="text-gray-700 mb-4 text-xl">
      Choose a dog food that prioritizes high-quality proteins, making real meat the primary ingredient as 
      boxer’s are large breed dogs that require protein for muscle development.
    </p>
  </div>
  ...
  {[
    ...
    <div className="mb-8">
      ...
      <p className="text-gray-700 mb-4 text-xl">
        Feed your Boxer, food with high-quality ingredients, such as real meat and vegetables.
      ...
      <span className="absolute bottom-2 right-2 inline-flex items-center justify-center w-7 h-7 bg-orange-500 text-white text-lg font-bold rounded-full shadow-md transform transition-all duration-300 group-hover:translate-x-1 group-hover:bg-orange-600">
        ...
        {/* Diet/Health Section */}
          ...
          <section className="mb-12 bg-orange-50 p-8 rounded-lg shadow-md">
            <h2 className="text-3xl font-bold text-gray-800 mb-6 text-center border-b-2 border-gray-400 pb-2">Boxer Common health concerns</h2>
            <div className="flex flex-col lg:flex-row items-center gap-8">
              <div className="lg:w-1/2 flex flex-col justify-between">
                <h3 className="text-lg text-gray-700 mb-6 font-semibold">
                  To safeguard the health of Boxers, we must understand the common concerns and provide 
                  optimal care and timely intervention.
                </h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-4 bg-orange-100 rounded-lg shadow-sm">
                    <h3 className="text-xl font-semibold mb-2">Hypothyroidism</h3>
                    <p className="text-sm text-gray-600">
                      Some Boxers may develop an underactive thyroid gland (hypothyroidism), 
                      resulting in weight gain, lethargy, and skin problems.
                    </p>
                  </div>
                  <div className="p-4 bg-orange-100 rounded-lg shadow-sm">
                    <h3 className="text-xl font-semibold mb-2">Hip dysplasia</h3>
                    <p className="text-sm text-gray-600">
                      Similar to many larger breeds, Boxers can be prone to hip dysplasia, 
                      affecting the hip joints, causing discomfort and mobility issues.
                    </p>
                  </div>
                  <div className="p-4 bg-orange-100 rounded-lg shadow-sm">
                    <h3 className="text-xl font-semibold mb-2">Heart Conditions</h3>
                    <p className="text-sm text-gray-600">
                      Boxers are susceptible to a genetic condition called "cardiomyopathy" that 
                      affects the heart muscle, leading to cardiac issues and, in severe cases, heart failure
                    </p>
                  </div>
                  <div className="p-4 bg-orange-100 rounded-lg shadow-sm col-span-1 md:col-span-2">
                    <h3 className="text-xl font-semibold mb-2">Cancer</h3>
                    <p className="text-sm text-gray-600">
                      Unfortunately, Boxers have an increased risk of developing certain types of cancer, Including lymphoma, mast cell tumours, and other malignancies
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div ref={trainingRef}>
          <section className="mb-12 bg-gray-100 p-8 rounded-lg shadow-md">
            <h2 className="text-3xl font-bold text-gray-800 mb-6 text-center border-b-2 border-gray-400 pb-2">Boxer Training</h2>
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div>
                <p className="text-xl text-gray-700 mb-6 ">
                  Boxers' innate intelligence and eager-to-please nature make
                  them highly adaptable to training sessions. Let’s find out how to begin.
                ...
                <div className="mb-6">
                  ...
                  <p className="text-gray-600 text-xl mb-4">
                    Engaging Boxers in activities like jogging, playing fetch, and going on 
                    long hikes helps to meet their exercise needs and keep them physically active.
                  </p>
     <div className="flex flex-wrap gap-4 justify-center md:justify-start">
  {[
      ...
      <span className="absolute bottom-2 right-2 inline-flex items-center justify-center w-7 h-7 bg-orange-500 text-white text-lg font-bold rounded-full shadow-md transform transition-all duration-300 group-hover:translate-x-1 group-hover:bg-orange-600">
        →
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-xl mb-4">
                    They require interactive play for essential mental stimulation. Provide interactive 
                    toys, puzzles, and engaging training exercises to keep their minds active.
                  </p>
    <div className="flex flex-wrap gap-4 justify-center md:justify-start">
  {[
        ...
        →
            ...
            <div className="mt-8 bg-white p-6 rounded-lg shadow-md flex flex-col md:flex-row items-center justify-between">
              <div className="md:w-2/3">
                ...
                <p className="text-gray-600">
                  Boxers excel in training, and utilising treats enhances their obedience to basic 
                  commands like 'sit,' 'stay,' 'come,' 'heel,' and 'down.' Positive reinforcement and 
                  reward-based training methods make the process enjoyable and highly effective. 
                </p>
    ...
    <div className="flex flex-col lg:flex-row items-center gap-8">
      <div className="lg:w-1/2 flex-shrink-0">
        <p className="text-lg text-gray-700 mb-6">
          Regular grooming is essential for Boxers, 
          despite their short and smooth coats. Keep these in mind while grooming a Boxer.
        </p>
      </div>
  ...
  <div className="mb-10 flex flex-col lg:flex-row items-center gap-10">
    ...
    <div className="lg:w-1/2">
      ...
      <p className="text-gray-600 leading-relaxed">
        Regularly brush your Boxer's coat to remove loose 
        hair and maintain healthy skin and coat. Bathe as needed using a mild dog shampoo.
  ...
  <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center">
    ...
    <div className="md:w-1/2 w-full p-8 flex items-center justify-center">
      <p className="text-black text-xl md:text-2xl font-semibold leading-relaxed text-center md:text-left">
        Keep There Training Sessions Engaging By using Different Technique Games And Challenge to Keep there 
        mind Stimulated. Incorporating  fun and Intractive Elememnts help to maintain there interest and focus.
